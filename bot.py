...
texto_3 = 'Entonces... a lo que iba. Poco a poco te vas conviertiendo en alguien muy importante para mí. No llevamos un mes y ya eres mi persona favorita :) \n\nMe haces muy feliz chiquita, no te imaginas cuanto. Antes tenía que lidiar con muchos problemas solo, pero ahora cuando algo me afecta, me das un besito y me ayudas a resolverlo. No pense que fuera a tener eso nunca, no pense que fuera a tenerte a tí... Tengo mucha suerte de tener el don para hacerte reír 😌 \n\nPresiona /here para continuar leyendo'
